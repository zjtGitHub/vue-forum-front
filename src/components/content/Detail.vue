    ...
    <div class="layui-col-md8 content detail">
      <div class="fly-panel detail-box">
        ...
        <div class="detail-body photos">
          <p>
            该模版由 layui官方社区（<a href="/" target="_blank">fly.layui.com</a>）倾情提供，只为表明我们对 layui 执着的信念、以及对未来持续加强的承诺。该模版基于 layui 搭建而成，可作为极简通用型社区的页面支撑。
          </p>
          <p>更新日志：</p>
<pre>
# v3.0 2017-11-30
...
* 更友好的响应式适配能力
          ...
          下载<hr>
          <p>
            官网：<a href="/template/fly/" target="_blank">/template/fly/</a><br>
          ...
          封面<hr>
          <p>
            <!-- <img src="../../res/images/fly.jpg" alt="Imooc社区"> -->
          </p>
        </div>
      </div>
